 ...
 * </pre> */
public class FixGridRender implements RenderInterface, Serializable {
  ...
  public FixGridRender(Tensor x, Tensor y, Color color) {
   ...
   * @param x vector of coordinates along the x axis
   * @param y vector of coordinates along the y axis */
  public FixGridRender(Tensor x, Tensor y) {
    this(x, y, COLOR_DEFAULT);
  }

  /** @param vector of coordinates along the x axis and y axis
   * @param color of grid lines */
  public FixGridRender(Tensor vector, Color color) {
    this(vector, vector, color);
  }

  /** @param vector of coordinates along the x axis and y axis */
  public FixGridRender(Tensor vector) {
    this(vector, vector);
  }
